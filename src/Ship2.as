package 
{
	...
	{
		// Sprite
		[Embed(source="../assets/playerShip3_blue.png")]
		...
		public function Ship2(x:Number = 0, y:Number = 0) 
		{
		...
		private function CheckKeys():void 
		{
			...
			if (Input.check(Key.UP))
				...
				vy *= friction;
			// Shoot
			if (Input.check(Key.NUMPAD_0) && canShoot)
				Fire();
		}
		...
		private function Fire():void 
		{
			canShoot = false;
			fireWait = 0;
			this.world.add(new ShipBullet2(centerX, top - 10));
			shoot.play();
		}
